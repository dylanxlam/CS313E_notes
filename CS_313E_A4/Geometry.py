...
class Sphere(object):
    ...
    def does_intersect_sphere(self, other):
        ...
        distance_squared = (self.center.x - other.center.x) ** 2 + (self.center.y - other.center.y) ** 2 + (self.center.z - other.center.z) ** 2
    ...
    def does_intersect_cube(self, a_cube):
        ...
        # Calculate the squared distance between the sphere's center and the closest point on the cube
